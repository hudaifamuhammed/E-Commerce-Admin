...
import upoad_area from '../../assets/upload_area.svg'
import responseData from 'react'
    ...
    <div className='add-product'>
      ...
      <div className="addproduct-itemfield">
        {/* <label htmlFor="file-input">
          <img src={image?URL.createObjectURL(image):upoad_area} className='addproduct-thumbnail-img'/>
        </label> */}
